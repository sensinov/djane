...
router.post(configPath.basePath+'/entityOperations/create', auth.checkToken, function(req, res) {
...
router.post(configPath.basePath+'/entityOperations/upsert', auth.checkToken, function(req, res) {
...
router.post(configPath.basePath+'/entityOperations/update', auth.checkToken, function(req, res) {
	var flagValue = req.query.flag;
	var Data = req.body ;
	var entities_id = '[' ;
	for (var j=0; j < Data.length; j ++ ) {
...
router.post(configPath.basePath+'/entityOperations/delete', auth.checkToken, function(req, res) {
	var Data = req.body ;
	var entities_id = '[' ;
	for (var j=0; j < Data.length; j ++ ) {
		entities_id = entities_id + '{ \'id \' : ' + Data[j].id +  '}' ;
